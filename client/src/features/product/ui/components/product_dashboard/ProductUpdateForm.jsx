  ...
  if (!currentProduct) {
    return (
      <div className="p-6 sm:p-8">
        <p className="text-ink-300 text-sm">Product not found.</p>
        <button
          type="button"
          onClick={() => navigate("/dashboard/product")}
          className="mt-3 flex items-center gap-2 px-4 py-2.5 rounded-lg border border-surface-600/50 text-ink-300 hover:text-ink-100 hover:border-surface-600 transition-colors cursor-pointer"
        >
          <ArrowLeft size={16} />
          Back to products
        </button>
